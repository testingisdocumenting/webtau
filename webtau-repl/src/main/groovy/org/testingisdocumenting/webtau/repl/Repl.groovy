...
class Repl {
    ...
    private Groovysh createShell() {
        ...
        shell.imports << "static org.testingisdocumenting.webtau.repl.ReplCommands.*"
        shell.imports << "static org.testingisdocumenting.webtau.repl.ReplHttpLastValidationCapture.*"
