...
class DataNodeIdTest {
    ...
    @Test
    void "concat empty param"() {
        def id = new DataNodeId("parent")
        def concat = id.concat("")
        concat.name.should == "parent"
        concat.path.should == "parent"
        concat.normalizedPath.should == "parent"
    }
}
