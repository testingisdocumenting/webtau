...
public abstract class MapAsExpectedCompareToHandlerBase implements CompareToHandler {
    @Override
    public boolean handleEquality(Object actual, Object expected) {
        return isMapOfProps(expected) && handleEquality(actual);
    }

    abstract protected boolean handleEquality(Object actual);
