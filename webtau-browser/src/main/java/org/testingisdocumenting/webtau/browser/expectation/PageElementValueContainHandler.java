...
public class PageElementValueContainHandler implements ContainHandler {
    @Override
    ...
    public void analyzeContain(ContainAnalyzer containAnalyzer, ActualPath actualPath, Object actual, Object expected) {
        PageElementValue<?> elementValue = (PageElementValue<?>) actual;
        containAnalyzer.contains(actualPath, elementValue.get(), expected);
    }

    @Override
    public void analyzeNotContain(ContainAnalyzer containAnalyzer, ActualPath actualPath, Object actual, Object expected) {
        PageElementValue<?> elementValue = (PageElementValue<?>) actual;
        containAnalyzer.notContains(actualPath, elementValue.get(), expected);
    }
}
